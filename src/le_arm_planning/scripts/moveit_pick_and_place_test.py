...
class MoveItPickAndPlaceDemo:
    def __init__(self):
        ...
        # 初始化ROS节点
        rospy.init_node('moveit_pick_and_place_test')
        ...
        box1_pose.pose.position.x = 0.23
        ...
        box2_pose.pose.position.x = 0.20
    ...
    def make_gripper_posture(self, joint_positions):
        ...
        # 设置夹爪的关节名称
        t.joint_names = ['gripper_base_link']
    ...
    def make_grasps(self, initial_pose_stamped, allowed_touch_objects):
        ...
        g.grasp_posture = self.make_gripper_posture([-0.59])
